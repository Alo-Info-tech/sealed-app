...
class DocumentsTab4 extends StatefulWidget {
  const DocumentsTab4({Key? key}) : super(key: key);

  @override
  State<DocumentsTab4> createState() => _DocumentsTab4State();
}

class _DocumentsTab4State extends State<DocumentsTab4> {
  @override
              ...
              return InkWell(
                onTap: () {
                  documentEditBottomSheet(
                      context: context, text: tab4[index].title);
                },
                child: Container(
