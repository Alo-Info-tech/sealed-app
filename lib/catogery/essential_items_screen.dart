...
import '../profile screens/terms_conditions.dart';
...
double essentialpicklat = 0.0;
double essentialpicklng = 0.0;
double essentialdelilat = 0.0;
double essentialdelilng = 0.0;

class EssentialItemsScreen extends StatefulWidget {
  const EssentialItemsScreen({Key? key}) : super(key: key);
...
class _EssentialItemsScreenState extends State<EssentialItemsScreen> {
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: selectController.esspick.toString() == ""
                        ? Padding(
                        ...
                        : Padding(
                            padding: const EdgeInsets.all(15.0),
                            child: Text(
                              selectController.esspick.toString(),
                              style: TextStyle(
                                  fontWeight: FontWeight.w100, fontSize: 14),
                            ),
                          ),
                ...
                InkWell(
                    ...
                    child: Container(
                      ...
                      child: selectController.essdelivery.toString() == ""
                          ? Padding(
              ...
              ElevatedButton(
                  onPressed: () {
                    if ( //instructioncontroller.text.isEmpty ||
                        selectController.esspick.toString().isEmpty ||
                            instructioness.isEmpty ||
                            selectController.essdelivery.toString().isEmpty) {
                      ...
                      Navigator.push(
                        ...
                        PageTransition(
                          ...
                          child: PaymenttScreen(
                            instruction: instructioness,
                            pickupAddress: selectController.esspick.toString(),
                            deliveryAddress:
                                selectController.essdelivery.toString(),
                            onOrround:
  ...
  Text validation(SelectAddressController selectAddressController) {
    if (picklat == delilat) {
      ...
      return Text(
        selectAddressController.essdelivery.toString(),
        ...
        onSelected: (bool value) {
          setState(() {
            ...
            if (chipsList[i].isSelected == true) {
              instructioness.add(chipsList[i].label.toString());
              print(instructioness);
            } else {
              instructioness
