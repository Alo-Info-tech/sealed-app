...
class _MedicalReportScreenState extends State<MedicalReportScreen> {
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: selectController.medipickup.toString() == ""
                          ? Padding(
                          ...
                          : Padding(
                              ...
                              child: Text(
                                selectController.medipickup.toString(),
                                style: TextStyle(
                                    fontWeight: FontWeight.w100, fontSize: 14),
                              ),
                            ),
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: selectController.medidelivery.toString() == ""
                          ? Text("")
          ...
          bottomSheet: Container(
            ...
            child: Row(
              ...
              children: [
                ElevatedButton(
                    onPressed: () {
                      if (selectController.medipickup.toString().isEmpty ||
                          insturctionmed.isEmpty ||
                          selectController.medidelivery.toString().isEmpty) {
                        ...
                        Navigator.push(
                          ...
                          PageTransition(
                            ...
                            child: PaymenttScreen(
                              instruction: insturctionmed,
                              pickupAddress:
                                  selectController.medipickup.toString(),
                              deliveryAddress:
                                  selectController.medidelivery.toString(),
                              onOrround:
  ...
  Text validation(SelectAddressController selectAddressController) {
    if (picklat == delilat) {
      ...
      return Text(
        selectAddressController.medidelivery.toString(),
        ...
        onSelected: (bool value) {
          setState(() {
            ...
            if (chipsList[i].isSelected == true) {
              insturctionmed.add(chipsList[i].label.toString());
              print(insturctionmed);
            } else {
              insturctionmed
